      ...
      <ul class="menu">
        ...
        <a href="dashboard.php">
            <i class="fa-solid fa-cloud-sun-rain"></i>
              ...
              <ul id="exportsMenu" class="dropdown">
                  <li><a href="exporters.html">LIST OF EXPORTERS</a></li>
                  <li><a href="market-analysis.html">MARKET ENTRY ANALYSIS</a></li>
                  <li><a href="crops-market.html">CROPS MARKET REPORT</a></li>
                  <li><a href="products.html">PRODUCTS</a></li>
                  <li><a href="country-export-requirement.html">COUNTRY EXPORT REQUIREMENTS</a></li>
              </ul>
            </a>
        <li>
          <a href="dashboard.php">
      ...
      <div class="gango">
       ...
       <div class="duke">
          ...
          <div class="hastings">
            ...
            <?php $sql=mysqli_query($con,"SELECT * FROM `admin`");
            ...
            <h3>SYSTEM USER</h3>
            <hr>
            <h3><i class="fa-solid fa-person"></i>FARMER</h3>
            <hr>
...
<?php
  if(isset($_POST['submit'])){
    ...
    $sql=mysqli_query($con,"UPDATE `admin` SET u_name='$name', u_email ='$email', u_address = '$address' , u_password='$password' WHERE id='$id' ");
